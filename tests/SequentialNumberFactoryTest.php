...
use Spielfigur\LaravelSequentialNumberGenerator\SequentialNumberFactory;

class SequentialNumberFactoryTest extends TestCase
{
    /** @test */
    public function it_returns_the_ascending_following_sequential_number_first_test()
    {
        $value      = 'COMPANYNAME/2019-12-02/001';
        $factory    = new SequentialNumberFactory();
        $nextNumber = $factory->generateNumber($value, '/', 2, 3);
    ...
    public function it_returns_the_ascending_following_sequential_number_second_test()
    {
        ...
        $factory    = new SequentialNumberFactory();
        $nextNumber = $factory->generateNumber($value, '-', 0, 3);
    ...
    public function it_returns_an_error_if_string_does_not_contain_the_number_on_the_given_place()
    {
        ...
        $factory    = new SequentialNumberFactory();
        $nextNumber = $factory->generateNumber($value, '/', 1, 3);
